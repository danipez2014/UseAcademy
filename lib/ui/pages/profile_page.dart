...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ProfileNavigationArguments profileArguments =
        ProfileNavigationArguments(name: '', age: 0, height: 0);
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Text(
                        'Nome: ${argumentsMap.isNotEmpty ? argumentsMap['name'] : profileArguments.name}'),
                    Text(
                        'Idade: ${argumentsMap.isNotEmpty ? argumentsMap['age'] : profileArguments.age}'),
                  ],
                ),
              ),
              ElevatedButton(
